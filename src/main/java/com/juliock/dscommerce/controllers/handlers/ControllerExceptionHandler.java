...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<CustomError> resourceNotFound(ResourceNotFoundException e, HttpServletRequest request) {
        ...
        *
        *   Queremos mandar uma mensagem personalizada no corpo da Response quando esse erro acontecer.
        *       Para isso, primeiro vamos instanciar um objeto que representa a estrutura da mensagem personalizada:
        ...
        *
        *   Depois de criar o objeto, vamos criar um objeto ResponseEntity, com o status code e o corpo contendo a estrutura CustomError, pra retornar.
        *
